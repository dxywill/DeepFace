...
[train_geom_data] = Read_geom_files_dynamic(train_users, [hog_data_dir, '/../model_params']);
...
[devel_geom_data] = Read_geom_files_dynamic(devel_users, [hog_data_dir, '/../model_params']);
